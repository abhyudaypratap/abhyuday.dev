  ...
  return (
    <section className="min-h-screen w-full snap-start">
      <div className="w-full p-12 relative">
        {/* Year Header */}
        <h2 className="text-[12rem] font-bold text-white/5 absolute -top-8 right-8 pointer-events-none select-none">
          {year}
        </h2>

        {/* Featured Image */}
        {displayImage && (
          <div className="relative h-[50vh] w-full mb-8 overflow-hidden rounded-2xl">
            <img
              src={displayImage}
